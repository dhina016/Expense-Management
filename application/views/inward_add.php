        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add Inward</h2>
                            <p class="pageheader-text">Inward add</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Dashboard</li>
                                        <li class="breadcrumb-item">Inward</li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Inward</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <h5 class="card-header">Add Inward</h5>
                    <div class="card-body">
                        <?php $msg = $this->session->flashdata("msg");
                        ?>
                        <div class="<?php echo $msg['name'];
                                    ?>" role="alert">
                            <strong><?php echo $msg['error'];
                                    ?></strong>
                        ...
                        <form method="post" action="<?php echo base_url('inwardadd/add') ?>">
