                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">View Outward</h2>
                            <p class="pageheader-text">add Outward</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Dashboard</li>
                                        <li class="breadcrumb-item">Outward</li>
                                        <li class="breadcrumb-item active" aria-current="page">View Outward</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Manage Outward</h5>
                        </div>
                        <div class="card-body">
                                        ...
                                        <?php if ($result == false) {
                                            ...
                                            foreach ($result  as $r) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-primary btn-primary" onclick="window.location.href ='<?php echo base_url('outwardview/outwardDelete/') . $r->id; ?>'">
