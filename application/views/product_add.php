            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            ...
                            <p class="pageheader-text">Product add</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo base_url('productadd/addProduct') ?>">
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label">Product Name</label>
                                <input id="inputText3" type="text" name="product" placeholder="Enter product" class="form-control" autocomplete="off">
                                <p class="text-danger"><?php echo form_error('product'); ?></p>
                            </div>
                            <div class="form-group">
                                <label for="inputText4" class="col-form-label">Enter Price</label>
                                <input id="inputText4" type="number" name="price" class="form-control" placeholder="Enter Price" autocomplete="off">
                            ...
                            <div class="form-group">
                                <center> <button class="btn btn-primary btn-lg">Add Product</button></center>
                            </div>
                        </form>
                    </div>
                </div>
